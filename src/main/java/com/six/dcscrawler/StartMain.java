...
public class StartMain extends WebMvcConfigurerAdapter {
	...
	@Autowired
	private ClusterManagerService clusterManager;

	public ClusterManagerService getClusterManager() {
		return clusterManager;
	}

	public void setClusterManager(ClusterManagerService clusterManager) {
