...
import com.six.dcscrawler.dao.provider.PageDaoProvider;
...
public interface PageDao extends BaseDao {
	...
	public Page queryBySiteAndKey(@Param("siteCode") String siteCode, @Param("pageKey") String pageKey);
